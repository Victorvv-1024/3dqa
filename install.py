...
# pytorch_version = torch.__version__.split('+')[0].replace('.', '')

# install_command = f"pip install mmcv-full https://download.openmmlab.com/mmcv/dist/cu{cuda_version}/torch{pytorch_version}/index.html"  # noqa: E501
